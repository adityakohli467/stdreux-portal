...
//             <Button size="lg" className="bg-[#105a9c] hover:bg-[#0d4a82] text-white px-12 py-6 text-lg mt-6">
//               Register Now
//             </Button>
//           </Link>
//         </div>
...
//             </div>
//             <Link href="/auth/register?type=wholesale">
//               <Button className="bg-[#105a9c] hover:bg-[#0d4a82] text-white px-8">
//                 Register
//               </Button>
//             </Link>
//           </div>
...
//           </p>
//           <Link href="/auth/register?type=wholesale">
//             <Button size="lg" className="bg-[#105a9c] hover:bg-[#0d4a82] text-white px-10">
//               Register Now!
//             </Button>
//           </Link>
//         </div>
...
//             <Button 
//               type="submit" 
//               className="w-full py-6 bg-[#105a9c] hover:bg-[#0d4a82] text-white font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed"
